...
@EnableConfigurationProperties({AnaliticsProperties.class,ClientSftpProperties.class, BehaviorProperties.class, ActivitiProperties.class, AmazonProperties.class,AmazonIntegrationProperties.class, EmailServiceProperties.class})
